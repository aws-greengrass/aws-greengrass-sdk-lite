set(_gg_sdk_dir ${CMAKE_CURRENT_LIST_DIR})

if(NOT TARGET unity)
  file(GLOB_RECURSE UNITY_SRCS CONFIGURE_DEPENDS "${unity_SOURCE_DIR}/src/*.c")
  file(GLOB_RECURSE UNITY_CFG_SRCS CONFIGURE_DEPENDS
       "${_gg_sdk_dir}/unity/unity_config/*.c")
  ...
  target_include_directories(unity PUBLIC ${_gg_sdk_dir}/unity/unity_config)
  target_include_directories(unity SYSTEM INTERFACE "${unity_SOURCE_DIR}/src")
  target_include_directories(unity PRIVATE "${unity_SOURCE_DIR}/src"
                                           ${_gg_sdk_dir}/priv_include)
...
file(GLOB_RECURSE GG_TEST_SRCS CONFIGURE_DEPENDS
     "${_gg_sdk_dir}/unity/gg_test/*.c")
add_library(gg-test EXCLUDE_FROM_ALL ${GG_TEST_SRCS})

target_include_directories(gg-test SYSTEM
                           INTERFACE ${_gg_sdk_dir}/unity/gg_test/include)
target_include_directories(gg-test PRIVATE ${_gg_sdk_dir}/unity/gg_test/include
                                           ${_gg_sdk_dir}/priv_include)
...
set(aws-greengrass-component-sdk_C_TEST_DIR ${_gg_sdk_dir}/test)

if(NOT BUILD_SHARED_LIBS)
  file(GLOB_RECURSE MOCKS CONFIGURE_DEPENDS "${_gg_sdk_dir}/mock/*.c")
  ...
  target_include_directories(
    gg-ipc-mock PRIVATE ${_gg_sdk_dir}/mock ${_gg_sdk_dir}/include
                        ${_gg_sdk_dir}/priv_include)
  target_include_directories(
    gg-ipc-mock SYSTEM INTERFACE ${_gg_sdk_dir}/mock
                                 ${_gg_sdk_dir}/priv_include)
